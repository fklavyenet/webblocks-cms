    ...
    return PluginDefinition::make(self::HANDLE)
      ...
      ->settings(
        PluginSettingsDefinition::make('webblocks.plugins.webblocks_commerce.settings.edit')
          ...
          ->description('Configure PayPal or SumUp with write-only encrypted credentials, and review checkout and webhook readiness. Environment configuration remains an optional override.')
      )
