...
return [
  ...
  'export' => [
    ...
    'public_demo' => [
        // Public demo mode is deliberately fail-closed. Enabling the feature is
        // not enough: the app must also run in the expected environment and on
        // the exact expected host before the one-click session can be created.
        'enabled' => (bool) env('WEBBLOCKS_CMS_PUBLIC_DEMO_ENABLED', false),
        'environment' => env('WEBBLOCKS_CMS_PUBLIC_DEMO_ENVIRONMENT', 'demo'),
        'host' => env('WEBBLOCKS_CMS_PUBLIC_DEMO_HOST'),
        'user_email' => env('WEBBLOCKS_CMS_PUBLIC_DEMO_USER_EMAIL'),
        'login_rate_limit_per_minute' => (int) env('WEBBLOCKS_CMS_PUBLIC_DEMO_LOGIN_RATE_LIMIT', 10),
        'reset_enabled' => (bool) env('WEBBLOCKS_CMS_PUBLIC_DEMO_RESET_ENABLED', false),
        'expected_database' => env('WEBBLOCKS_CMS_PUBLIC_DEMO_DATABASE'),
        'marker_path' => env('WEBBLOCKS_CMS_PUBLIC_DEMO_MARKER_PATH'),
        'seeder' => env('WEBBLOCKS_CMS_PUBLIC_DEMO_SEEDER'),
        'minimum_sites' => (int) env('WEBBLOCKS_CMS_PUBLIC_DEMO_MINIMUM_SITES', 1),
        'minimum_pages' => (int) env('WEBBLOCKS_CMS_PUBLIC_DEMO_MINIMUM_PAGES', 1),
        'allowed_write_routes' => [
            'admin.pages.update',
            'admin.pages.workflow',
            'admin.pages.publish-page-owned-blocks',
            'admin.pages.translations.store',
            'admin.pages.translations.update',
            'admin.pages.slots.blocks.reorder',
            'admin.blocks.store',
            'admin.blocks.update',
            'admin.blocks.destroy',
            'admin.blocks.move-up',
            'admin.blocks.move-down',
            'admin.blocks.status.update',
            'admin.navigation.store',
            'admin.navigation.update',
            'admin.navigation.destroy',
        ...
        'denied_read_routes' => [
            ...
            'admin.system.*',
            'admin.plugins.*',
            'admin.site-transfers.*',
            'admin.sites.*',
            'admin.locales.*',
            'admin.page-layouts.*',
            'admin.block-types.*',
            'admin.embedded-applications.*',
