...
- system updates with Update Summary, Install Update, Diagnostics, compact Update History, release-note and package-safety accordions, site export/import tools with a direct Sites-list export shortcut, preserved navigation item icons, and package-based Site Promotion workflows
