...
- `docs/block-type-contracts.md` is the Phase 1 read-only inventory for the currently published core block type contracts, and `ddev artisan block-types:contracts-audit` gives a safe source-level audit of the shipped catalog plus admin and public view presence.
