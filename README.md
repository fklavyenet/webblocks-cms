...
- managed install-level Page Layouts with validated public body classes and relational Page Layout Slots, while pages still store the selected layout handle on `public_shell` for backward compatibility
