...
- system updates with a guided operator status hero, release preview, backup-protected update options, update history, technical details kept last, site export/import tools with a direct Sites-list export shortcut, preserved navigation item icons, and package-based Site Promotion workflows
