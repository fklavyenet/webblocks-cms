...
use WebBlocks\Cms\Http\Requests\Admin\PageLayoutRequest;
...
class PageLayoutController extends Controller
{
    ...
    public function create(Request $request): View
    {
        ...
        return view('webblocks-cms::admin.page-layouts.create', [
    ...
    public function edit(Request $request, PageLayout $pageLayout): View
    {
        ...
        return view('webblocks-cms::admin.page-layouts.edit', [
