  ...
  public function index(Request $request): JsonResponse
  {
    ...
    return response()->json([
      ...
      'recommended_next_steps' => [
        ...
        'Use GET/PUT /webadmin/api/sites/{site}/assets/{css|js} with site-assets.read/write for canonical physical site.css and site.js edits; include expected_checksum on writes.',
  ...
  public function aiGuide(): JsonResponse
  {
    return response()->json([
      ...
      'content' => implode("\n\n", [
        ...
        'Canonical site CSS/JS file edits require explicit `site-assets.read` and `site-assets.write`. Read `GET /webadmin/api/sites/{site}/assets/css`, update the returned `contents`, then write with `PUT /webadmin/api/sites/{site}/assets/css` and the returned `expected_checksum` value. The same pattern works for `js`. Do not invent alternate public paths or database-backed CSS fallbacks.',
  ...
  private function workflows(CmsApiToken $token): array
  {
    ...
    return [
      ...
      'canonical_site_assets' => [
        ...
        'steps' => [
          'GET /webadmin/api/sites/{site}/assets/css or /assets/js with site-assets.read',
