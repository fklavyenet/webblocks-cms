  ...
  public function index(Request $request): JsonResponse
  {
    ...
    return response()->json([
      ...
      'recommended_next_steps' => [
        ...
        'Use GET /webadmin/api/locales to inspect install locales, POST /webadmin/api/locales to create a locale, and PATCH /webadmin/api/locales/{locale} to update locale code, name, enabled state, or default status. Locale writes require site-settings.write.',
  ...
  private function openApiPaths(): array
  {
    ...
    return [
      ...
      '/locales' => [
        ...
        'post' => ['summary' => 'Create a locale', 'x-required-capability' => 'site-settings.write', 'x-supported-fields' => ['code', 'name', 'is_default', 'is_enabled'], 'x-default-locale-behavior' => 'Setting is_default=true makes the locale enabled and demotes other default locales through the normal CMS locale invariant.', 'responses' => ['201' => ['description' => 'Created locale JSON', 'content' => $json], '403' => ['description' => 'Requires site-settings.write capability', 'content' => $json], '422' => ['description' => 'Validation JSON', 'content' => $json]]],
      ],
      '/locales/{locale}' => [
        'patch' => ['summary' => 'Update safe locale fields', 'x-required-capability' => 'site-settings.write', 'x-supported-fields' => ['code', 'name', 'is_default', 'is_enabled'], 'x-default-locale-behavior' => 'The default locale must stay enabled; setting is_default=true demotes other default locales through the normal CMS locale invariant.', 'responses' => ['200' => ['description' => 'Updated locale JSON', 'content' => $json], '403' => ['description' => 'Requires site-settings.write capability', 'content' => $json], '422' => ['description' => 'Validation JSON', 'content' => $json]]],
      ],
