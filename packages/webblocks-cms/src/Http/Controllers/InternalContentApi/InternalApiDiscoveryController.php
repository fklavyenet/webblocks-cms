  ...
  public function aiGuide(): JsonResponse
  {
    return response()->json([
      ...
      'content' => implode("\n\n", [
        ...
        'Canonical site CSS/JS file edits require explicit `site-assets.read` and `site-assets.write`. Read `GET /webadmin/api/sites/{site}/assets/css`, inspect `asset.readiness` and `asset.guidance`, update the returned `contents`, then write with `PUT /webadmin/api/sites/{site}/assets/css` and the returned `expected_checksum` value. The same pattern works for `js`. Hosting permission failures return JSON `422` with `asset.write`; do not invent alternate public paths or database-backed CSS fallbacks.',
  ...
  private function workflows(CmsApiToken $token): array
  {
    ...
    return [
      ...
      'canonical_site_assets' => [
        ...
        'steps' => [
          'GET /webadmin/api/sites/{site}/assets/css or /assets/js with site-assets.read and inspect asset.readiness and asset.guidance',
