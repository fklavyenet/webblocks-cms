...
class SiteDomainUpdateRequest extends FormRequest
{
    ...
    {
        /** @var SiteDomain|null $siteDomain */
        $siteDomain = $this->route('domain');

        return [
            'domain' => ['required', 'string', 'max:255', Rule::unique(SiteDomain::class, 'domain')->ignore($siteDomain?->id)],
