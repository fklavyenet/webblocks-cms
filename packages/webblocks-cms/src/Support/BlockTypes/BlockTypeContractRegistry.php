...
class BlockTypeContractRegistry
{
  ...
  private function documentedContracts(): array
  {
    return [
      ...
      'content_header' => [
        'admin_form_fields' => ['Title', 'Intro text', 'Icon', 'Icon tone', 'Badge label', 'Badge tone', 'Meta items'],
        'translatable_fields' => ['title', 'eyebrow as badge_label', 'subtitle', 'meta'],
        'shared_settings_fields' => ['settings.alignment', 'settings.icon_slug', 'settings.icon_tone', 'settings.badge_tone'],
        'storage_fields' => [
