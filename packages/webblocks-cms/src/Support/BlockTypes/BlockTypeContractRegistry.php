  ...
  private function documentedContracts(): array
  {
    return [
      ...
      'card' => [
        ...
        'media_relationship_fields' => ['Child region blocks are the primary relationship. Legacy card media is read only for old saved cards with no region children.'],
      ...
      'card_header' => [
        'admin_form_fields' => ['Admin label', 'Icon', 'Badge tone'],
        'translatable_fields' => [],
        'shared_settings_fields' => ['settings.layout_name', 'settings.icon_slug', 'settings.badge_tone'],
        'storage_fields' => [
          'Card Header shell settings stay in block settings.',
          'Optional icon slug and badge tone stay in shared block settings.',
        ],
      ...
      'content_header' => [
        'admin_form_fields' => ['Title', 'Intro text', 'Icon', 'Badge label', 'Badge tone', 'Meta items'],
        'translatable_fields' => ['title', 'eyebrow as badge_label', 'subtitle', 'meta'],
        'shared_settings_fields' => ['settings.alignment', 'settings.icon_slug', 'settings.badge_tone'],
        'storage_fields' => [
          ...
          'Shared alignment, active catalog icon slug, and badge tone stay in block settings.',
        ],
      ...
      'column_item' => [
        'admin_form_fields' => ['Column Title', 'Optional Link', 'Column Text', 'Icon', 'Badge label', 'Badge tone'],
        'translatable_fields' => ['title', 'eyebrow as badge_label', 'subtitle', 'content'],
        'shared_settings_fields' => ['url', 'settings.icon_slug', 'settings.badge_tone'],
        'storage_fields' => [
          ...
          'Shared active catalog icon slug and badge tone stay in block settings.',
        ],
      ...
      'link-list-item' => [
        'admin_form_fields' => ['Title', 'URL', 'Optional Meta', 'Icon', 'Badge label', 'Badge tone', 'Optional Description'],
