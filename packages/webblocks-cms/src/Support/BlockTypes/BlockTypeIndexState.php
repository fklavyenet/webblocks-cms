...
class BlockTypeIndexState
{
    ...
    public function sanitizeReturnUrl(?string $candidate): ?string
    {
        ...
        $expectedPath = rtrim(route('admin.block-types.index', [], false), '/');
        ...
        return route('admin.block-types.index', $this->normalizeQuery($query));
    }
