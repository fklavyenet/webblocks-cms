...
See [CONTRIBUTING.md](CONTRIBUTING.md) and [DEVELOPMENT.md](DEVELOPMENT.md). Package CI also validates a temporary current-Laravel consumer, the Laravel `13.0.*` dependency floor, documentation, and the exported distribution boundary.

## Support and security

Use the [issue tracker](https://github.com/fklavyenet/webblocks-cms/issues) for reproducible bugs and feature requests. Do not disclose vulnerabilities publicly; follow [SECURITY.md](SECURITY.md).
