@extends('webblocks-cms::layouts.admin', ['title' => 'Page Types', 'heading' => 'Page Types'])
...
@section('content')
    ...
    <div class="wb-card">
        <div class="wb-card-body">
            <div class="wb-table-wrap">
                <table class="wb-table wb-table-striped wb-table-hover">
                    <thead>
                        <tr>
                            <th>Name</th><th>Slug</th><th>Description</th><th>Pages</th><th>Sort Order</th><th>Status</th><th>System</th><th>Actions</th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach ($pageTypes as $pageType)
                            <tr>
                                ...
                                <td class="wb-nowrap"><div class="wb-action-group"><a href="{{ route('admin.page-types.edit', $pageType) }}" class="wb-action-btn wb-action-btn-edit"><i class="wb-icon wb-icon-pencil" aria-hidden="true"></i></a><form method="POST" action="{{ route('admin.page-types.destroy', $pageType) }}">@csrf @method('DELETE')<button type="submit" class="wb-action-btn wb-action-btn-delete"><i class="wb-icon wb-icon-trash" aria-hidden="true"></i></button></form></div></td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
        ...
        @include('webblocks-cms::admin.partials.pagination', ['paginator' => $pageTypes])
    </div>
@endsection
