...
@section('content')
    ...
    <div class="wb-grid wb-grid-2">
        <div class="wb-card">
            <form method="POST" action="{{ route('admin.profile.update') }}" class="wb-stack wb-gap-0">
                @csrf
                @method('PUT')
        ...
        <div class="wb-card">
            <form method="POST" action="{{ route('admin.profile.password.update') }}" class="wb-stack wb-gap-0">
                @csrf
                @method('PUT')
