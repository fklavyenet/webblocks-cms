...
return new class extends Migration
{
  public function up(): void
  {
    Schema::table('sites', function (Blueprint $table): void {
      ...
      $table->foreignId('favicon_asset_id')->nullable()->after('is_primary')->constrained('assets')->nullOnDelete();
      $table->string('seo_title')->nullable()->after('favicon_asset_id');
      $table->text('seo_description')->nullable()->after('seo_title');
      $table->string('seo_keywords')->nullable()->after('seo_description');
      $table->foreignId('social_image_asset_id')->nullable()->after('seo_keywords')->constrained('assets')->nullOnDelete();
    });
  }
