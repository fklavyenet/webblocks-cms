...
return new class extends Migration
{
  public function up(): void
  {
    ...
    Schema::table('cms_api_tokens', function (Blueprint $table): void {
      if (! Schema::hasColumn('cms_api_tokens', 'capabilities')) {
        $table->json('capabilities')->nullable()->after('token_preview');
      }

      if (! Schema::hasColumn('cms_api_tokens', 'last_used_user_agent')) {
