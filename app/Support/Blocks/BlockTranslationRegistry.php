...
class BlockTranslationRegistry
{
    public function familyFor(Block|string|null $block): ?string
    {
        ...
        return match ($slug) {
            'header', 'plain_text', 'rich-text', 'content_header', 'button_link', 'card', 'stat-card', 'alert', 'link-list', 'link-list-item', 'sidebar-brand', 'sidebar-navigation', 'sidebar-nav-item', 'sidebar-nav-group', 'sidebar-footer', 'search-form', 'sticky-navbar' => 'text',
            'button' => 'button',
            'image' => 'image',
