...
- Source page URL and CMS preview URL are separate: source content comes from `https://webblocksui.com/docs/architecture.html`, `https://webblocksui.com/docs/foundation.html`, and `https://webblocksui.com/docs/layout.html`, while local CMS preview uses the default site host and current CMS path model.
