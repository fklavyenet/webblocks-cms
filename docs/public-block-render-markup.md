...
The renderer includes hidden fields, CSRF, honeypot markup with CMS-specific `wb-public-contact-honeypot`, targeted validation errors, and posts to `contact-messages.store`.
