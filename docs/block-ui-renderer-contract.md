...
- CSS: `https://cdn.jsdelivr.net/gh/fklavyenet/webblocks-ui@v2.7.16/packages/webblocks/dist/webblocks-ui.css`
- Icons CSS: `https://cdn.jsdelivr.net/gh/fklavyenet/webblocks-ui@v2.7.16/packages/webblocks/dist/webblocks-icons.css`
- JS: `https://cdn.jsdelivr.net/gh/fklavyenet/webblocks-ui@v2.7.16/packages/webblocks/dist/webblocks-ui.js`
...
- When CMS pre-renders a shared dialog layer under `#wb-overlay-root`, that layer must stay unhidden so WebBlocks UI `v2.7.16` can portal trusted modal and gallery targets into it without leaving them inside a hidden ancestor.
