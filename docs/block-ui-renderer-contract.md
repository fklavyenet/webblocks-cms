...
- CSS: `https://raw.githubusercontent.com/fklavyenet/webblocks-ui/v2.7.8/packages/webblocks/dist/webblocks-ui.min.css`
- Icons CSS: `https://raw.githubusercontent.com/fklavyenet/webblocks-ui/v2.7.8/packages/webblocks/dist/webblocks-icons.min.css`
- JS: `https://raw.githubusercontent.com/fklavyenet/webblocks-ui/v2.7.8/packages/webblocks/dist/webblocks-ui.min.js`
...
- When CMS pre-renders a shared dialog layer under `#wb-overlay-root`, that layer must stay unhidden so WebBlocks UI `v2.7.8` can portal trusted modal and gallery targets into it without leaving them inside a hidden ancestor.
