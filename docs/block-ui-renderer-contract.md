...
- CSS: `https://cdn.jsdelivr.net/gh/fklavyenet/webblocks-ui@v2.7.7/packages/webblocks/dist/webblocks-ui.css`
- JS: `https://cdn.jsdelivr.net/gh/fklavyenet/webblocks-ui@v2.7.7/packages/webblocks/dist/webblocks-ui.js`
...
- When CMS pre-renders a shared dialog layer under `#wb-overlay-root`, that layer must stay unhidden so WebBlocks UI `v2.7.7` can portal trusted modal and gallery targets into it without leaving them inside a hidden ancestor.
