# WebBlocks CMS Changelog Archive - 1.31 and earlier

This file contains older release notes moved from CHANGELOG.md so the main changelog can remain a recent rolling changelog. Release headings and notes are preserved as written.
