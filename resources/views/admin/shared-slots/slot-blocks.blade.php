...
@section('content')
    ...
    <div class="wb-stack wb-gap-4" data-wb-cms-slot-block-tree data-wb-shared-slot-id="{{ $sharedSlot->id }}" data-page-id="{{ $sourcePage->id }}" data-slot-type-id="{{ $slot->slot_type_id }}">
                    ...
                    <div class="wb-filter-bar wb-filter-bar--fields" role="search">
                        <div class="wb-filter-bar-fields">
                            <div class="wb-field wb-filter-bar-search">
                                <label for="shared_slot_block_search" class="wb-label">{{ $adminTranslator->admin('common.search', $adminLocale) }}</label>
                                <input id="shared_slot_block_search" type="search" class="wb-input" data-wb-slot-block-search autocomplete="off" placeholder="{{ $adminText('search_placeholder') }}">
                            </div>
