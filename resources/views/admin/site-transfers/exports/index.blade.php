...
@section('content')
    ...
    <div class="wb-stack wb-gap-4">
        <div class="wb-card">
            ...
            @include('admin.partials.pagination', ['paginator' => $exports, 'compact' => true, 'ariaLabel' => 'Exports pagination'])
        </div>
        ...
        <div class="wb-card">
            ...
            @include('admin.partials.pagination', ['paginator' => $imports, 'compact' => true, 'ariaLabel' => 'Imports pagination'])
        </div>
    </div>
