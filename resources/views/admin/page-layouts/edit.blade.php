        ...
        <div class="wb-stack wb-gap-4">
            <div class="wb-card wb-card-muted">
                ...
                <div class="wb-card-body wb-stack wb-gap-2 wb-text-sm">
                    ...
                    <div><strong>Shell Type:</strong> {{ str($pageLayout->shell_type)->headline() }}</div>
            ...
            @if ($pageLayout->is_system)
                <div class="wb-card wb-card-muted">
                    ...
                    <div class="wb-card-body wb-text-sm wb-text-muted">
                        System layouts keep their handle and shell type fixed for backward compatibility. You can still rename, describe, activate, deactivate, and reorder them.
                    </div>
                </div>
            @endif
        </div>
