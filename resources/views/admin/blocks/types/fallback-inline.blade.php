@php
    ...
    $adminText = fn (string $key) => $adminTranslator->get('admin.blocks.fallback_inline.'.$key, $adminLocale);
@endphp
...
<div class="wb-stack wb-gap-4">
    ...
    <div class="wb-grid wb-grid-2">
        ...
        <div class="wb-stack wb-gap-1">
            <label for="block_{{ $index }}_asset_id">{{ $adminText('media_asset_id') }}</label>
