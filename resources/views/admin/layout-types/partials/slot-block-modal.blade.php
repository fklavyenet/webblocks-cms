@php
    ...
    $modalTitle = $isCreateMode
        ? 'Add Block: '.$blockName.' ('.$layoutName.' / '.$slotName.')'
        : 'Edit Block: '.$blockName.' ('.$layoutName.' / '.$slotName.')';
    ...
    $closeUrl = route('admin.layout-types.slots.blocks', [$layoutType, $slot, 'picker' => $isCreateMode ? 1 : null, 'parent_id' => $isCreateMode ? (request()->integer('parent_id') ?: null) : null]);
