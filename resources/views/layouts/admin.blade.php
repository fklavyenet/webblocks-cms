    ...
    <head>
        ...
        @php
            ...
            if (! $adminNavbarBreadcrumb) {
                ...
                $adminNavbarBreadcrumb = '<nav class="wb-breadcrumb" aria-label="'.e($adminText('page_layouts.breadcrumb')).'"><ol class="wb-breadcrumb-list">';
