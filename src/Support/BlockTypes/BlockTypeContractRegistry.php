    ...
    return [
      ...
      'hero' => [
        ...
        'storage_fields' => [
          ...
          'Internal Content API callers set primary_cta and secondary_cta objects ({label, url}); the CMS turns them into the same managed button_link children the admin editor maintains. Free-form button children are not accepted.',
        ],
      ...
      'link-list' => [
        'admin_form_fields' => ['Intro title', 'Intro subtitle', 'Intro content', 'Row layout', 'List frame', 'Link list items'],
        'translatable_fields' => ['title', 'subtitle', 'content'],
        'shared_settings_fields' => ['settings.row_layout', 'settings.list_frame'],
        'storage_fields' => [
          'Translated intro copy lives in block text translation rows.',
          'Shared row layout and list frame styles stay in block settings.',
        ...
        'renderer_root_contract' => 'Owns its public `.wb-link-list` root when published child rows exist, adding `wb-link-list--stacked` and `wb-link-list--cards` for the selected styles.',
        'current_contract_status' => 'clear',
        'known_gaps' => [],
      ],
      'link-list-item' => [
