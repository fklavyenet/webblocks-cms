  ...
  public function definitions(): array
  {
    return [
      ...
      [
        ...
        'slug' => 'columns',
        'category' => 'content',
        'description' => 'Structured repeated content; starts unframed for qualities and benefits, with opt-in cards or stats.',
        'source_type' => 'static',
        'is_system' => false,
        'is_container' => true,
        'sort_order' => 5,
      ...
      [
        ...
        'slug' => 'toc',
        'category' => 'navigation',
        'description' => 'Table of contents built from anchored Header blocks in the same slot.',
        'source_type' => 'static',
        'is_system' => true,
        'is_container' => false,
        'sort_order' => 20,
      ...
      [
        ...
        'slug' => 'feature-grid',
        'category' => 'content',
        'description' => 'Legacy card-only feature section; prefer Columns for new content unless every item needs a card boundary.',
        'source_type' => 'static',
        'is_system' => false,
        'is_container' => true,
        'sort_order' => 24,
