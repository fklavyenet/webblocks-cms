...
class PageRequest extends FormRequest
{
  ...
  public function rules(): array
  {
    ...
    return [
      ...
      'blocks.*.id' => ['nullable', 'integer', 'exists:wbcms_blocks,id'],
      'blocks.*.block_type_id' => ['required', 'integer', 'exists:wbcms_block_types,id'],
      'blocks.*.slot_type_id' => ['nullable', 'integer', 'exists:wbcms_slot_types,id'],
      ...
      'blocks.*.media_id' => ['nullable', 'integer', 'exists:wbcms_media,id'],
      'blocks.*.asset_id' => ['nullable', 'integer', 'exists:wbcms_media,id'],
      'blocks.*.gallery_media_ids' => ['nullable', 'array'],
      'blocks.*.gallery_media_ids.*' => ['integer', 'exists:wbcms_media,id'],
      'blocks.*.gallery_asset_ids' => ['nullable', 'array'],
      'blocks.*.gallery_asset_ids.*' => ['integer', 'exists:wbcms_media,id'],
      'blocks.*.gallery_items' => ['nullable', 'array'],
      'blocks.*.gallery_items.*.media_id' => ['required_with:blocks.*.gallery_items', 'integer', 'exists:wbcms_media,id'],
