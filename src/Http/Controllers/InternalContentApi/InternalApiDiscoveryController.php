  ...
  public function index(Request $request): JsonResponse
  {
    ...
    return response()->json([
      ...
      'recommended_next_steps' => [
        ...
        'Use GET /webadmin/api/applications with applications.read to discover database-registered Embedded Applications and read each application settings schema before placing an Application Block. Registry writes require applications.write; deletion requires applications.delete.',
