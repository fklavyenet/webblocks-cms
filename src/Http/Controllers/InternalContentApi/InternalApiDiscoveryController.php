...
class InternalApiDiscoveryController extends Controller
{
  ...
  public function index(Request $request): JsonResponse
  {
    ...
    return response()->json([
      ...
      'recommended_next_steps' => [
        ...
        'Use GET /webadmin/api/applications with applications.read to discover manifest-backed Embedded Applications and read each application settings schema before placing an Application Block.',
  ...
  private function openApiPaths(): array
  {
    ...
    return [
      ...
      '/applications' => ['get' => ['summary' => 'List registered Embedded Applications', 'x-required-capability' => 'applications.read', 'x-filters' => ['render_mode', 'readiness', 'search'], 'responses' => ['200' => ['description' => 'Application registry JSON', 'content' => $json], '403' => ['description' => 'Requires applications.read capability', 'content' => $json]]]],
      '/applications/{application}' => ['get' => ['summary' => 'Read one Embedded Application definition', 'x-required-capability' => 'applications.read', 'parameters' => [$pathParameter('application', 'Application handle')], 'responses' => ['200' => ['description' => 'Application definition JSON', 'content' => $json], '404' => ['description' => 'Application not found', 'content' => $json]]]],
