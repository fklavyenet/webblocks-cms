  ...
  private function openApiPaths(): array
  {
    ...
    return [
      ...
      '/system/cleanup' => [
        ...
        'put' => ['summary' => 'Replace maintenance cleanup retention settings', 'x-required-capability' => 'maintenance.settings.write', 'x-required-fields' => ['asset_revision_days', 'keep_latest_asset_revisions', 'temporary_workspace_hours'], 'responses' => ['200' => ['description' => 'Updated policy and overview JSON', 'content' => $json], '422' => ['description' => 'Validation JSON', 'content' => $json]]],
      ],
      '/system/cleanup/{category}/run' => ['post' => ['summary' => 'Run one safe maintenance cleanup category', 'x-required-capability' => 'maintenance.delete', 'x-destructive' => true, 'x-supported-categories' => ['asset-revisions', 'media-variants', 'temporary-workspaces'], 'responses' => ['200' => ['description' => 'Cleanup result JSON', 'content' => $json], '404' => ['description' => 'Unsupported category', 'content' => $json]]]],
      ...
      '/pages/{page}/versions' => ['get' => ['summary' => 'List saved page versions with change summaries', 'x-required-capability' => 'content.read', 'responses' => ['200' => ['description' => 'Version list JSON', 'content' => $json]]]],
