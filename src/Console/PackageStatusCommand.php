...
class PackageStatusCommand extends Command
{
  ...
  public function handle(): int
  {
    ...
    $this->line('Target Composer update flow: '.WebBlocksCmsServiceProvider::TARGET_UPDATE_COMMAND.' followed by package-aware migration handling, cache clear, asset publish or sync when needed, package diagnostics, and installed-version sync when release state is real; catalog repair remains explicit maintenance.');
