...
return new class extends Migration
{
  ...
  {
    if (Schema::hasTable('comment_entries') && ! Schema::hasTable('wbcms_comment_entries')) {
      Schema::rename('comment_entries', 'wbcms_comment_entries');
    }

    if (Schema::hasTable('content_ratings') && ! Schema::hasTable('wbcms_content_ratings')) {
      Schema::rename('content_ratings', 'wbcms_content_ratings');
    }
  ...
  {
    // Repair migrations intentionally preserve engagement data on rollback.
  }
};
