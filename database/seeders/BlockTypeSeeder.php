...
class BlockTypeSeeder extends Seeder
{
    public function run(): void
    {
        collect([
            ...
            ['name' => 'Feature Item', 'slug' => 'feature-item', 'category' => 'data display', 'description' => 'Child item for a Feature Grid block with translated title and supporting copy plus an optional shared link.', 'source_type' => 'static', 'is_system' => false, 'is_container' => false, 'sort_order' => 45, 'status' => 'published'],
            ...
            ['name' => 'CTA', 'slug' => 'cta', 'category' => 'marketing', 'description' => 'A focused call-to-action section with translated copy and up to two managed CTA buttons.', 'source_type' => 'static', 'is_system' => false, 'is_container' => true, 'sort_order' => 50, 'status' => 'published'],
            ...
            ['name' => 'Column Item', 'slug' => 'column_item', 'category' => 'layout helper', 'source_type' => 'static', 'is_system' => false, 'is_container' => false, 'sort_order' => 52, 'status' => 'published'],
            ['name' => 'Link List', 'slug' => 'link-list', 'category' => 'content', 'description' => 'Render a WebBlocks link list with translated intro copy and managed link-list-item children.', 'source_type' => 'static', 'is_system' => false, 'is_container' => true, 'sort_order' => 53, 'status' => 'published'],
            ['name' => 'Link List Item', 'slug' => 'link-list-item', 'category' => 'content', 'description' => 'Child item for a Link List block with translated title, meta, and description plus a shared URL.', 'source_type' => 'static', 'is_system' => false, 'is_container' => false, 'sort_order' => 54, 'status' => 'published'],
            ['name' => 'Split', 'slug' => 'split', 'category' => 'layout helper', 'source_type' => 'static', 'is_system' => false, 'is_container' => true, 'sort_order' => 55, 'status' => 'published'],
            ['name' => 'Stack', 'slug' => 'stack', 'category' => 'layout helper', 'source_type' => 'static', 'is_system' => false, 'is_container' => true, 'sort_order' => 56, 'status' => 'published'],
            ['name' => 'Grid', 'slug' => 'grid', 'category' => 'layout helper', 'source_type' => 'static', 'is_system' => false, 'is_container' => true, 'sort_order' => 57, 'status' => 'published'],
            ['name' => 'Card Group', 'slug' => 'card-group', 'category' => 'layout helper', 'source_type' => 'static', 'is_system' => false, 'is_container' => true, 'sort_order' => 58, 'status' => 'published'],
            ['name' => 'Page Title', 'slug' => 'page-title', 'category' => 'system', 'source_type' => 'system', 'is_system' => true, 'is_container' => false, 'sort_order' => 59, 'status' => 'published'],
            ['name' => 'Page Content', 'slug' => 'page-content', 'category' => 'system', 'source_type' => 'system', 'is_system' => true, 'is_container' => false, 'sort_order' => 60, 'status' => 'published'],
            ['name' => 'Page Meta', 'slug' => 'page-meta', 'category' => 'system', 'source_type' => 'system', 'is_system' => true, 'is_container' => false, 'sort_order' => 61, 'status' => 'published'],
            ['name' => 'Navigation Auto', 'slug' => 'navigation-auto', 'category' => 'system', 'description' => 'Renders navigation items assigned to a system location such as header or footer.', 'source_type' => 'navigation', 'is_system' => true, 'is_container' => false, 'sort_order' => 62, 'status' => 'published'],
            ['name' => 'Auth Form', 'slug' => 'auth-form', 'category' => 'system', 'source_type' => 'system', 'is_system' => true, 'is_container' => false, 'sort_order' => 63, 'status' => 'published'],
            ['name' => 'Cookie Notice', 'slug' => 'cookie-notice', 'category' => 'system', 'source_type' => 'system', 'is_system' => true, 'is_container' => false, 'sort_order' => 64, 'status' => 'published'],
