...
class PublicEditorialBlocksRenderingTest extends TestCase
{
  ...
  {
    foreach (['header', 'plain_text', 'rich-text', 'section', 'container', 'cluster', 'grid', 'content_header', 'button_link', 'card', 'alert', 'breadcrumb', 'header-actions', 'rating', 'comments', 'sticky-navbar', 'navbar-brand', 'navbar-navigation', 'sidebar-brand', 'sidebar-navigation', 'sidebar-nav-item', 'sidebar-nav-group', 'sidebar-footer'] as $slug) {
  ...
  #[Test]
  public function grid_can_reorder_direct_section_columns_for_alternating_media_text_rows(): void
  {
    $page = $this->pageWithMainSlot();
    $grid = Block::query()->create([
      'page_id' => $page->id,
    ...
    $response->assertDontSee('<div class="wb-stack wb-gap-4" data-wb-public-block-type="grid">', false);
  }
