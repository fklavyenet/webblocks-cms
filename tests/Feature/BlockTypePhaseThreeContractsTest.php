...
class BlockTypePhaseThreeContractsTest extends TestCase
{
  ...
  public function phase_three_contracts_report_the_resolved_block_gaps(): void
  {
    ...
    $this->assertSame(['url', 'settings.icon_slug', 'settings.icon_tone', 'settings.badge_tone'], $columnItem->sharedSettingsFields);
    ...
    $this->assertSame(['title', 'eyebrow as badge_label', 'content'], $featureItem->translatableFields);
    $this->assertSame(['url', 'settings.icon_slug', 'settings.icon_tone', 'settings.badge_tone'], $featureItem->sharedSettingsFields);
    ...
    $this->assertSame(['media_id', 'settings.layout_name', 'settings.background_position', 'settings.background_overlay'], $card->sharedSettingsFields);
    ...
    $this->assertSame(['media_id', 'settings.alignment', 'settings.icon_slug', 'settings.icon_tone', 'settings.badge_tone', 'settings.background_position', 'settings.background_overlay'], $contentHeader->sharedSettingsFields);
