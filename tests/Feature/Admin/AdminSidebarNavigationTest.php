...
class AdminSidebarNavigationTest extends TestCase
{
  ...
  public function admin_resource_screens_apply_the_authenticated_admin_locale_beyond_the_shell(): void
  {
    ...
    $expectations = [
      ...
      route('admin.page-layouts.index') => ['Seitenlayouts', 'Neues Seitenlayout', 'Aktiv', 'Page Layouts'],
      route('admin.system.api-tokens.index') => ['CMS-API-Token', 'Berechtigungen', 'Seitenaufbau', 'Capabilities'],
