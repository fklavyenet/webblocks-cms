...
class IconCatalogManagementTest extends TestCase
{
  ...
  #[Test]
  public function default_icon_sync_manifest_is_pinned_to_webblocks_ui_v2718(): void
  {
    $this->assertSame(
      'https://cdn.jsdelivr.net/gh/fklavyenet/webblocks-ui@v2.7.18/packages/webblocks/dist/webblocks-icons.json',
