...
class PackageStatusCommandTest extends TestCase
{
    ...
    public function package_status_command_is_registered_and_reports_package_resource_boundary_state_read_only(): void
    {
        ...
        $this->artisan('webblocks:package-status')
            ...
            ->expectsOutputToContain('Package public model foundation moves present: yes (ContactMessage, Locale, PublicSearchIndex, Site, SiteDomain, SystemSetting, VisitorEvent)')
            ->expectsOutputToContain('Root public model compatibility wrappers present: yes')
            ->expectsOutputToContain('Public model foundation package authority state: partial (Locale, Site, SiteDomain, ContactMessage, PublicSearchIndex, VisitorEvent, and SystemSetting now live under package Models while root App\\Models wrappers remain active for compatibility; Page, PageTranslation, PageSlot, and Block remain root-owned due to broader admin, search, translation, layout, and media coupling).')
