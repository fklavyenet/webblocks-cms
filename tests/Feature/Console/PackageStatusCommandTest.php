...
class PackageStatusCommandTest extends TestCase
{
    ...
    public function package_status_command_is_registered_and_reports_package_resource_boundary_state_read_only(): void
    {
        ...
        $this->artisan('webblocks:package-status')
            ...
            ->expectsOutputToContain('Package view files status: package files present (admin/runtime-status.blade.php, admin/system/icons/index.blade.php, admin/system/icons/partials/edit-modal.blade.php, diagnostics/package-status.blade.php, public/pages/show.blade.php, public/runtime-status.blade.php, public/search/show.blade.php)')
            ...
            ->expectsOutputToContain('Root view compatibility state: mixed (icon and public search/page entry views now render through the package namespace, while most admin and layout views remain root-owned).')
            ...
            ->expectsOutputToContain('Package public assets status: package files present (cms/package-boundary.json)')
            ...
            ->expectsOutputToContain('Future package public asset Composer readiness: partial (package publishable asset marker exists; current WebBlocks UI CDN pinning and root asset flow stay unchanged).')
