...
class PackageStatusCommandTest extends TestCase
{
    ...
    public function package_status_command_is_registered_and_reports_package_resource_boundary_state_read_only(): void
    {
        ...
        $this->artisan('webblocks:package-status')
            ...
            ->expectsOutputToContain('Package view files status: package files present (admin/runtime-status.blade.php, admin/system/icons/index.blade.php, admin/system/icons/partials/edit-modal.blade.php, diagnostics/package-status.blade.php, public/runtime-status.blade.php)')
