...
class ReleasePackageBoundaryTest extends TestCase
{
  ...
  public function git_attributes_excludes_project_layer_from_release_exports(): void
  {
    ...
    $this->assertStringContainsString('/ai/** export-ignore', $attributes);
  ...
  public function release_artifact_includes_package_owned_admin_title_runtime_files(): void
  {
    ...
    $this->assertStringContainsString("'title' => \$adminText('dashboard.title')", $dashboard);
  ...
  public function release_artifact_includes_contact_form_check_public_css_in_package_assets(): void
  {
    ...
    $this->assertStringContainsString('background-color: var(--wb-public-tone-bold, var(--wb-color-heading, #0f172a));', $publicCss);
