...
use Database\Seeders\SyncUiDocsGettingStartedSeeder;
...
class PublicGettingStartedDocsPageTest extends TestCase
{
    ...
    public function getting_started_docs_page_renders_in_docs_shell_and_sync_stays_idempotent(): void
    {
        ...
        $this->seed(SyncUiDocsGettingStartedSeeder::class);
        ...
        $response->assertSee('data-wb-slot="header" class="wb-navbar wb-navbar-glass"', false);
