...
class MediaVariantCardStructureTest extends TestCase
{
  ...
  public function image_variants_use_equal_preview_cards_with_structured_regions(): void
  {
    ...
    $this->assertStringContainsString('class="wb-card-body wb-media-variant-grid"', $view);
    ...
    $this->assertStringContainsString('grid-template-columns: repeat(auto-fill, minmax(13rem, 1fr));', $css);
