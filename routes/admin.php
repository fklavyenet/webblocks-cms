...
Route::middleware(['web', 'install.required', 'throttle:internal-content-api', 'internal-api.token', CoalesceSearchIndexing::class])
  ...
  ->group(function () {
    ...
    Route::post('/sites/{site}/applications/{application}/package', [InternalApplicationAssetController::class, 'installPackage'])->middleware('internal-api.capability:applications.write')->name('applications.package.store');
    ...
    Route::post('/plugins/catalog/{plugin}/update', [InternalPluginController::class, 'catalogUpdate'])->middleware('internal-api.capability:plugins.install')->name('plugins.catalog.update');
...
Route::middleware(['web', 'install.required', UseCmsAuthenticationRedirect::class, 'admin.access', UseAdminLocale::class, CoalesceSearchIndexing::class])
  ...
  ->group(function () {
    ...
    Route::get('reports/visitors', [VisitorReportController::class, 'index'])->middleware('can:view-visitor-reports')->name('reports.visitors.index');
    ...
    Route::get('contact-messages', [AdminContactMessageController::class, 'index'])->middleware('can:manage-site-operations')->name('contact-messages.index');
    Route::delete('contact-messages/bulk', [AdminContactMessageController::class, 'bulkDestroy'])->middleware('can:manage-site-operations')->name('contact-messages.bulk-destroy');
    Route::get('contact-messages/{contactMessage}', [AdminContactMessageController::class, 'show'])->middleware('can:manage-site-operations')->name('contact-messages.show');
    Route::patch('contact-messages/{contactMessage}/status', [AdminContactMessageController::class, 'updateStatus'])->middleware('can:manage-site-operations')->name('contact-messages.status');
    ...
    Route::middleware('can:access-system')->group(function () {
      ...
      Route::resource('sites', SiteController::class)->except(['show', 'index', 'edit', 'update']);
